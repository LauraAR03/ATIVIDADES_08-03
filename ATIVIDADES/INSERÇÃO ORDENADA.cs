...
class Program
{
    ...
    static int EncontrarMaiorMenorQueX(int[] arr, int x)
    {
        int esquerda = 0, direita = arr.Length - 1;
        int resultado = -1;
    ...
    static void Main()
    {
        ...
        int x = 8;
        int maiorMenorQueX = EncontrarMaiorMenorQueX(numeros, x);
        Console.WriteLine(maiorMenorQueX != -1
            ? $"O maior número menor que {x} é {maiorMenorQueX}."
            : $"Não há número menor que {x} na lista.");
    }
}
